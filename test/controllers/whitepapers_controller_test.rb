...
class WhitepapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create whitepaper" do
    assert_difference('Whitepaper.count') do
      post whitepapers_url, params: { whitepaper: { filename: @whitepaper.filename, title: @whitepaper.title } }
    end
  ...
  test "should update whitepaper" do
    patch whitepaper_url(@whitepaper), params: { whitepaper: { filename: @whitepaper.filename, title: @whitepaper.title } }
