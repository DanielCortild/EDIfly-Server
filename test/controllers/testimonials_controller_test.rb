...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { date: @testimonial.date, from: @testimonial.from, name: @testimonial.name, testimonial: @testimonial.testimonial } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { date: @testimonial.date, from: @testimonial.from, name: @testimonial.name, testimonial: @testimonial.testimonial } }
